...
class Cody:
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters = dict(
            ...
            max_atom_step=kwargs.get('max_atom_step',0.2),
            ...
            target_orbitals_homo=kwargs.get('target_orbitals_homo', [0]),
            target_orbitals_lumo=kwargs.get('target_orbitals_lumo', [0]),
